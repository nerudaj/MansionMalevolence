...
const std::map<CardType, Card> CARD_DEFS = {
    ...
    { CardType::RocketLauncher,
      Card { .image = CardImage::RocketLauncher,
             .traits = CardTrait::Pickable | CardTrait::Weapon,
             .special = CardSpecial::NegatesEvasive,
             .specialSound = SoundId::Explosion,
             .quantity = 1,
             .power = 3,
             .name = "rocket launcher",
             .texts = { "negates evasive", "monster ability" }}},
    { CardType::Ammo,
    ...
    { CardType::MixedHerbs,
      Card { .image = CardImage::MixedHerbs,
             .traits = CardTrait::Pickable | CardTrait::Healing,
             .special = CardSpecial::HealBoost,
             .specialSound = SoundId::Heal,
             .power = 5,
             .name = "mixed herbs",
             .texts = {"restores to full","health.", "also increases", "max health."} } },
    { CardType::FirstAid,
